...
例如：cc-manager ls                                (默认: --client=claude --type=config)
     cc-manager --client=claude ls --type=agents   (列出 claude agents 配置)
     cc-manager --client=codex ls --type=config    (列出 codex config 配置)
     cc-manager --client=gemini ls --type=agents   (列出 gemini agents 配置)
